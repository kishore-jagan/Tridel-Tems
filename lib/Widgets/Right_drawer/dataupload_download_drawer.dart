...
class DataDownloadDrawer extends StatefulWidget {
  const DataDownloadDrawer({super.key});

  @override
  State<DataDownloadDrawer> createState() => _DataDownloadDrawerState();
}

class _DataDownloadDrawerState extends State<DataDownloadDrawer> {
